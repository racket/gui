...
(define-syntax entry-point 
  (lambda (stx)
    (syntax-case stx ()
      [(_ f)
       (syntax (lambda () (as-entry f)))])))

(define-syntax entry-point-1
  (lambda (stx)
    (syntax-case stx ()
      [(_ f)
       (syntax
...
(define-syntax entry-point-1-2-3
  (lambda (stx)
    (syntax-case stx ()
      [(_ l)
       (syntax
...
(define-syntax entry-point-0-1-2-3-4
  (lambda (stx)
    (syntax-case stx ()
      [(_ l)
       (syntax
