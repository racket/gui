...
@defmethod*[([(use-char-as-grapheme) boolean?]
             [(use-char-as-grapheme [char-mode? any/c]) void?])]{

Gets or sets whether non-@racketidfont{/char} methods accept and
return positions in terms of @tech{graphemes} or characters.

See @secref["graphemes"] for more information.
